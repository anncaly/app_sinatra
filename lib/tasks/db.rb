...
namespace :db do
  ...
  ENV['DATABASE'] = 'app_sinatra_dev' if environment == 'development'
  ENV['DATABASE'] = 'app_sinatra_test' if environment == 'test'
  ENV['DATABASE'] = 'app_sinatra_prod' if environment == 'production'
